...
from em_backend.agent.utils import retrieve_documents_from_user_question
...
class Agent:
    ...
    def get_compiled_agent_graph() -> Pregel[AgentState, AgentContext]:
        ...
        async def rephrase_question(
            ...
            rephrase_question_response = cast(
                "RephraseQuestionStructuredOutput",
            ...
            return {
                "messages": [
                    ...
                    HumanMessage(
                        id=uuid4(),
                        content=rephrase_question_response.rephrased_question,
                    ),
                ],
                "is_comparison_question": rephrase_question_response.is_comparison_question,
            }
        ...
        async def generate_comparison_answer(
            ...
            parties_data = "\n".join(
                [
                    ...
                    f"Top Candidate: {party.candidate.given_name} {party.candidate.family_name}\n"
                    f"Website: {party.url}\n"
                    f"### Party Documents\n"
                    + "\n".join(
                        [
